...
extern void printBaro();
extern void setAltHold(bool en);                          //with out remote control this
extern void setAltTarget(float meters);
extern bool altHoldEnabled;
extern float altTargetRel;
...
void doCommand(String str, bool echo = false) {
	...
	command.toLowerCase();
      ...
      printBaro();
                                                      // without remote control this
}   else if (command == "althold") {
    setAltHold(arg0.toInt() != 0);
    print("althold: %d\n", altHoldEnabled);

}   else if (command == "alt") {
  // meters above current when enabled
    mode = AUTO;                 // ensure AUTO
    setAltTarget(arg0.toFloat());
    print("alt target (m): %g\n", altTargetRel);
