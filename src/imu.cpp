...
void setupIMU() {
  ...
  // Use the 3-arg begin() to set frequency immediately (ESP32 supports this)
  Wire.begin(I2C_SDA_PIN, I2C_SCL_PIN); // 50kHz for debugging
  delay(500);
  ...
  configureIMU();
} // imu orientation as Euler angles
